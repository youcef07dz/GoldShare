...
//  + 7 themes: Gold, Sea, Nature, Fruits, Space, Fire, Moon
//    (theme repaints the GUI AND the hosted HTML page)
//  + QR code share/scan (pure C# QR encoder, no external libraries)
//  + Multi-language GUI: English / Français / العربية (with RTL)
//  + Persistent settings (GoldShare.ini: port + language + theme)
...
{
    // ========================================================================
    //  THEME — 7 palettes that drive BOTH the WinForms UI and the HTML page
    // ========================================================================
    public class Theme
    {
        public string Code;
        public Color Dark;    // deepest tone  (header gradient start, borders)
        public Color Mid;     // main brand    (header gradient mid, buttons)
        public Color Light;   // bright accent (header gradient end, highlights)
        public Color Soft;    // pale tint     (card borders, hover backgrounds)
        public Color Bg;      // window / page background
        public Color Text;    // main text color
        public Color FieldBg; // textbox / listbox background

        public Theme(string code, Color dark, Color mid, Color light,
                     Color soft, Color bg, Color text, Color fieldBg)
        {
            Code = code; Dark = dark; Mid = mid; Light = light;
            Soft = soft; Bg = bg; Text = text; FieldBg = fieldBg;
        }

        private static Theme current;
        public static Theme Current
        {
            get { if (current == null) current = Themes.Get("gold"); return current; }
            set { current = value; }
        }
        ...
        {
            int r = a.R + (int)((b.R - a.R) * t + 0.5);
            int g = a.G + (int)((b.G - a.G) * t + 0.5);
            int b2 = a.B + (int)((b.B - a.B) * t + 0.5);
    ...
    public static class Themes
    {
        ...
        {
            // code     dark                        mid                         light                        soft                        bg                           text                        fieldBg
            new Theme("gold",   Color.FromArgb(112,79,5),   Color.FromArgb(184,134,11), Color.FromArgb(233,215,138), Color.FromArgb(236,217,160), Color.FromArgb(253,250,243), Color.FromArgb(90,66,26),  Color.FromArgb(255,253,244)),
            new Theme("sea",    Color.FromArgb(5,68,94),    Color.FromArgb(24,154,180), Color.FromArgb(117,230,218), Color.FromArgb(190,230,238), Color.FromArgb(240,250,252), Color.FromArgb(15,80,105), Color.FromArgb(244,252,254)),
            new Theme("nature", Color.FromArgb(25,70,28),   Color.FromArgb(62,137,72),  Color.FromArgb(163,217,119), Color.FromArgb(205,235,190), Color.FromArgb(244,252,242), Color.FromArgb(35,85,40),  Color.FromArgb(247,253,245)),
            new Theme("fruits", Color.FromArgb(192,57,43),  Color.FromArgb(230,126,34), Color.FromArgb(249,199,79),  Color.FromArgb(250,220,180), Color.FromArgb(255,250,243), Color.FromArgb(150,60,25), Color.FromArgb(255,250,244)),
            new Theme("space",  Color.FromArgb(26,16,64),   Color.FromArgb(75,46,131),  Color.FromArgb(157,141,241), Color.FromArgb(205,198,240), Color.FromArgb(244,243,252), Color.FromArgb(45,35,90),  Color.FromArgb(247,246,254)),
            new Theme("fire",   Color.FromArgb(127,29,13),  Color.FromArgb(220,75,26),  Color.FromArgb(249,160,63),  Color.FromArgb(250,205,180), Color.FromArgb(253,245,241), Color.FromArgb(140,40,18), Color.FromArgb(255,247,243)),
            new Theme("moon",   Color.FromArgb(45,55,72),   Color.FromArgb(100,116,139),Color.FromArgb(203,213,225), Color.FromArgb(215,222,232), Color.FromArgb(246,248,251), Color.FromArgb(55,65,80),  Color.FromArgb(249,251,253))
        };

        public static Theme Get(string code)
        {
            for (int i = 0; i < All.Length; i++)
                if (All[i].Code == code) return All[i];
            return All[0]; // fallback: gold
        }
    ...
    public static class Settings
    {
        ...
        public static string Theme = "gold";
        ...
        public static void Load()
        {
            try
            {
                ...
                for (int i = 0; i < lines.Length; i++)
                {
                    ...
                    {
                        if (Themes.Get(val).Code == val) Theme = val;
                    }
                }
            }
            catch { }
    ...
    public static class L
    {
        ...
        private static Dictionary<string, string> MakeEn()
        {
            ...
            d.Add("theme_lbl", "Theme:");
            d.Add("theme_gold", "Gold");
            d.Add("theme_sea", "Sea");
            d.Add("theme_nature", "Nature");
            d.Add("theme_fruits", "Fruits");
            d.Add("theme_space", "Space");
            d.Add("theme_fire", "Fire");
            d.Add("theme_moon", "Moon");
            d.Add("msg_ready", "Ready. Press 'START SERVER'.");
        ...
        private static Dictionary<string, string> MakeFr()
        {
            ...
            d.Add("theme_lbl", "Th\u00E8me :");
            d.Add("theme_gold", "Or");
            d.Add("theme_sea", "Mer");
            d.Add("theme_nature", "Nature");
            d.Add("theme_fruits", "Fruits");
            d.Add("theme_space", "Espace");
            d.Add("theme_fire", "Feu");
            d.Add("theme_moon", "Lune");
            d.Add("msg_ready", "Pr\u00EAt. Cliquez sur \u00AB D\u00C9MARRER LE SERVEUR \u00BB.");
        ...
        private static Dictionary<string, string> MakeAr()
        {
            ...
            d.Add("theme_lbl", "\u0627\u0644\u0633\u0645\u0629:");
            d.Add("theme_gold", "\u0630\u0647\u0628\u064A");
            d.Add("theme_sea", "\u0628\u062D\u0631");
            d.Add("theme_nature", "\u0637\u0628\u064A\u0639\u0629");
            d.Add("theme_fruits", "\u0641\u0648\u0627\u0643\u0647");
            d.Add("theme_space", "\u0641\u0636\u0627\u0621");
            d.Add("theme_fire", "\u0646\u0627\u0631");
            d.Add("theme_moon", "\u0642\u0645\u0631");
            d.Add("msg_ready", "\u062C\u0627\u0647\u0632. \u0627\u0636\u063A\u0637 '\u062A\u0634\u063A\u064A\u0644 \u0627\u0644\u062E\u0627\u062F\u0645'.");
    ...
    static class Program
    {
        ...
        static void Main()
        {
            Settings.Load();                                   // port + language + theme
    ...
    // ========================================================================
    //  MAIN FORM (themed UI, fixed size, multilingual + RTL)
    // ========================================================================
    public class MainForm : Form
    {
        ...
        private void InitUI()
        {
            ...
            // ----- row 4 : log + theme + language -----
            lblLog = MakeLabel("", 24, 284, 100);
            this.Controls.Add(lblLog);

            lblTheme = MakeLabel("", 224, 284, 48);
            this.Controls.Add(lblTheme);

            cboTheme = new ComboBox();
            cboTheme.DropDownStyle = ComboBoxStyle.DropDownList;
            cboTheme.Location = new Point(272, 280);
            cboTheme.Size = new Size(128, 24);
            cboTheme.Font = new Font("Verdana", 8.25f, FontStyle.Bold);
        ...
        // --------------------------------------------------------------------
        //  APPLY LANGUAGE (re-text everything + RTL for Arabic + theme names)
        // --------------------------------------------------------------------
        private void ApplyLanguage()
        {
            ...
            // refresh theme dropdown display names for the new language
            int sel = cboTheme.SelectedIndex;
            if (sel < 0) sel = Themes.IndexOf(Settings.Theme);
        ...
        // --------------------------------------------------------------------
        //  APPLY THEME (recolor every control; buttons repaint from theme)
        // --------------------------------------------------------------------
        private void ApplyTheme()
        {
            ...
            lblPort.ForeColor = t.Text;
            lblFolder.ForeColor = t.Text;
            lblAddresses.ForeColor = t.Text;
            lblLog.ForeColor = t.Text;
            lblLang.ForeColor = t.Text;
            lblTheme.ForeColor = t.Text;

            txtPath.BackColor = t.FieldBg;
            lstUrls.BackColor = t.FieldBg;
            lstUrls.ForeColor = t.Text;
            lstLog.BackColor = t.FieldBg;
            lstLog.ForeColor = t.Text;
            cboTheme.BackColor = t.FieldBg;
            cboTheme.ForeColor = t.Text;
            cboLang.BackColor = t.FieldBg;
            cboLang.ForeColor = t.Text;

            headerPanel.Invalidate();
            foreach (Control c in this.Controls)
                if (c is GoldButton) c.Invalidate();
        }
        ...
        private void HeaderPaint(object sender, PaintEventArgs e)
        {
            ...
            using (LinearGradientBrush b = new LinearGradientBrush(r,
                t.Dark, t.Mid, LinearGradientMode.Horizontal))
                g.FillRectangle(b, r);
            ...
            using (Font f = new Font("Georgia", 20f, FontStyle.Bold))
            {
                ...
                Color titleCol = Theme.Mix(t.Light, Color.White, 0.88);
                using (SolidBrush sh = new SolidBrush(Color.FromArgb(90, 0, 0, 0)))
                    g.DrawString(title, f, sh, x + 2f, 14f + 2f);
                using (SolidBrush sb2 = new SolidBrush(titleCol))
                    g.DrawString(title, f, sb2, x, 14f);
            }
        ...
        // --------------------------------------------------------------------
        //  INDEX PAGE — themed HTML (colors derived from Theme.Current)
        // --------------------------------------------------------------------
        private string BuildIndexHtml()
        {
            Theme t = Theme.Current;

            // ---- derive the full CSS palette from the 7 base colors ----
            string cDark = Theme.Hex(t.Dark);
            string cMid = Theme.Hex(t.Mid);
            string cLight = Theme.Hex(t.Light);
            string cSoft = Theme.Hex(t.Soft);
            string cBg = Theme.Hex(t.Bg);
            string cTxt = Theme.Hex(t.Text);
            string cHead = Theme.Hex(Theme.Mix(t.Dark, t.Mid, 0.45));
            string cSize = Theme.Hex(Theme.Mix(t.Text, Color.White, 0.35));
            string cEmpty = Theme.Hex(Theme.Mix(t.Text, Color.White, 0.45));
            string cFooter = Theme.Hex(Theme.Mix(t.Text, Color.White, 0.5));
            string cHoverB = Theme.Hex(Theme.Mix(t.Soft, t.Mid, 0.5));
            string cBtnTop = Theme.Hex(Theme.Mix(t.Mid, t.Light, 0.35));
            string cBtnTxt = Theme.Hex(Theme.Mix(t.Light, Color.White, 0.9));
            string cBtnHov1 = Theme.Hex(Theme.Mix(t.Mid, t.Dark, 0.25));
            string cBtnHov2 = Theme.Hex(Theme.Mix(t.Mid, t.Dark, 0.7));
            string cBar1 = Theme.Hex(Theme.Mix(t.Mid, t.Light, 0.15));
            string cBar2 = Theme.Hex(Theme.Mix(t.Mid, t.Light, 0.5));
            string cTitle = Theme.Hex(Theme.Mix(t.Light, Color.White, 0.88));
            string cSub = Theme.Hex(Theme.Mix(t.Light, Color.White, 0.7));
            string shHero = Theme.Rgba(t.Dark, 0.35);
            string shCard = Theme.Rgba(t.Mid, 0.13);
            string shBtn = Theme.Rgba(t.Dark, 0.35);
            string shTitle = Theme.Rgba(Color.FromArgb(40, 28, 4), 0.6);
            ...
            sb.Append("body{margin:0;background:").Append(cBg)
              .Append(";font-family:Georgia,'Times New Roman',Tahoma,serif;color:").Append(cTxt).Append("}");
            sb.Append(".hero{background:linear-gradient(120deg,").Append(cDark).Append(",")
              .Append(cMid).Append(" 45%,").Append(cLight)
              .Append(");padding:34px 16px 26px;text-align:center;box-shadow:0 5px 24px ").Append(shHero).Append("}");
            sb.Append(".hero h1{margin:0;font-size:34px;color:").Append(cTitle)
              .Append(";letter-spacing:5px;text-shadow:0 2px 8px ").Append(shTitle).Append("}");
            sb.Append(".hero .sub{margin-top:6px;color:").Append(cSub)
              .Append(";font-style:italic;font-size:15px}");
            sb.Append(".badge{display:inline-block;margin-top:12px;background:rgba(255,255,255,.92);color:")
              .Append(cDark).Append(";border:1px solid ").Append(cSoft)
              .Append(";border-radius:20px;padding:4px 16px;font-size:13px;font-family:Verdana,sans-serif}");
            sb.Append(".wrap{max-width:840px;margin:26px auto 40px;padding:0 14px}");
            sb.Append(".card{background:#fff;border:1px solid ").Append(cSoft)
              .Append(";border-radius:14px;box-shadow:0 8px 26px ").Append(shCard)
              .Append(";padding:22px;margin-bottom:24px}");
            sb.Append(".card h2{margin:0 0 14px;font-size:17px;color:").Append(cHead)
              .Append(";letter-spacing:2px;border-bottom:2px solid ").Append(cSoft).Append(";padding-bottom:9px}");
            sb.Append(".file{display:flex;align-items:center;gap:11px;padding:10px 12px;margin:2px 0;border-radius:9px;text-decoration:none;color:").Append(cTxt).Append(";border:1px solid transparent}");
            sb.Append(".file:hover{background:").Append(cSoft).Append(";border-color:").Append(cHoverB).Append("}");
            sb.Append(".fname{word-break:break-all}");
            sb.Append(".fsize{margin-left:auto;color:").Append(cSize)
              .Append(";font-size:12px;white-space:nowrap;font-family:Verdana,sans-serif}");
            sb.Append(".empty{color:").Append(cEmpty).Append(";font-style:italic;padding:8px 4px}");
            sb.Append("input[type=file]{font-family:Verdana,sans-serif;font-size:14px;margin-bottom:14px;max-width:100%}");
            sb.Append(".btn{display:inline-block;background:linear-gradient(180deg,").Append(cBtnTop).Append(",")
              .Append(cMid).Append(");border:1px solid ").Append(cDark).Append(";color:").Append(cBtnTxt)
              .Append(";font-weight:bold;font-size:15px;letter-spacing:1px;padding:11px 30px;border-radius:9px;cursor:pointer;box-shadow:0 4px 12px ")
              .Append(shBtn).Append(";font-family:inherit}");
            sb.Append(".btn:hover{background:linear-gradient(180deg,").Append(cBtnHov1).Append(",").Append(cBtnHov2).Append(")}");
            sb.Append(".bar{height:14px;background:").Append(cSoft)
              .Append(";border-radius:8px;overflow:hidden;display:none;margin-top:14px}");
            sb.Append(".bar>div{height:100%;width:0;background:linear-gradient(90deg,").Append(cBar1).Append(",").Append(cBar2).Append(")}");
            sb.Append("#ptxt{font-size:12px;color:").Append(cHead)
              .Append(";font-family:Verdana,sans-serif;margin-top:5px;display:none}");
            sb.Append("footer{text-align:center;color:").Append(cFooter)
              .Append(";font-size:12px;padding:16px;font-family:Verdana,sans-serif}");
    ...
    public class QrCode
    {
        ...
        // --------------------------------------------------------------------
        //  RENDER TO BITMAP (dark ink kept near-black for scan reliability)
        // --------------------------------------------------------------------
    ...
    // ========================================================================
    //  QR DIALOG — phone scan / IP selector / save PNG / copy URL (themed)
    // ========================================================================
    public class QrForm : Form
    {
        ...
        public QrForm(List<string> urlList, int initialIndex)
        {
            ...
            if (urls.Count > 1)
            {
                ...
                cbo.BackColor = t.FieldBg;
                cbo.ForeColor = t.Text;
    ...
    // ========================================================================
    //  GOLD BUTTON (rounded, gradient, hover/press states — themed)
    // ========================================================================
    public class GoldButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!Enabled)
            {
                top = Color.FromArgb(226, 224, 218); bottom = Color.FromArgb(206, 204, 198);
                border = Color.FromArgb(190, 188, 182);
            }
            else if (pressed)
            {
                top = Theme.Mix(t.Mid, t.Dark, 0.55);
                bottom = Theme.Mix(t.Mid, t.Dark, 0.2);
                border = t.Dark;
            }
            else if (hovered)
            {
                top = Theme.Mix(t.Mid, t.Light, 0.5);
                bottom = Theme.Mix(t.Mid, t.Dark, 0.15);
                border = Theme.Mix(t.Dark, t.Mid, 0.2);
            }
            else
            {
                top = Theme.Mix(t.Mid, t.Light, 0.3);
                bottom = t.Mid;
                border = Theme.Mix(t.Dark, t.Mid, 0.25);
            }
            ...
            Color txt = Enabled ? Theme.Mix(t.Light, Color.White, 0.92)
                                : Color.FromArgb(140, 138, 132);
